...
Outside of class, I'm heavily involved with research as part of the [Dorrestein Lab](https://dorresteinlab.ucsd.edu/) at UCSD's [Skaggs School of Pharmacy & Pharmaceutical Sciences](https://pharmacy.ucsd.edu/), where I mainly focus on computational metabolomics. I've been fortunate to have had the opportunity to contribute to and lead a number of publications in this group, and I've received grants from OpenAI and Google DeepMind for my work.
