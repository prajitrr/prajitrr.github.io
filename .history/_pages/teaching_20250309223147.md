...
<em>My Thoughts:</em> For most students taking this course, this is their first time seeing calculus of any form, so the new ways of thinking it covers are definitely one of the biggest challenges. This course was also entirely online, and it's much harder to encourage participation over this modality, though Zoom does have some nice features to help ease the transition, like polls and student annotations. It's certainly not the same as teaching in-person, but it's definitely doable with enough practice. Something else I've realized that I previously took for granted is that it's important to make sure students to review notation, as this course introduces a lot of notation that might be new for students that instructors may take for granted. 
</div>
</div>
