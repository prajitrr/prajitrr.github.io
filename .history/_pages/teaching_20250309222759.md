...
<em>My Thoughts:</em> For most students taking this course, this is their first time seeing calculus of any form, so . Something else I've realized that's important is the need to make sure students to review notation, as this course introduces notation that might be new for students that instructors may take for granted. 
</div>
</div>
