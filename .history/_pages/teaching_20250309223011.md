...
<em>My Thoughts:</em> For most students taking this course, this is their first time seeing calculus of any form, so the new ways of thinking it covers are definitely one of the biggest challenges. This course was also entirely online, and it's certainly much harder to encourage participation over this modality, but Zoom does have some nice features to help ease the transition Something else I've realized that's important is the need to make sure students to review notation, as this course introduces notation that might be new for students that instructors may take for granted. 
</div>
</div>
